...
and (later) discrimination/calibration statistics for the open empirical question — does the validity
flag predict true abstraction errors? — so a Stage-1 study can be reported against TRIPOD+AI.
