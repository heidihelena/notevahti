...
DRIVERS = ["EGFR exon 19 deletion", "EGFR L858R", "ALK rearrangement", "ROS1 rearrangement",
           "BRAF V600E", "KRAS G12C", "MET exon 14 skipping", "RET fusion", "none"]
TARGETABLE = {"EGFR exon 19 deletion", "EGFR L858R", "ALK rearrangement", "ROS1 rearrangement",
              "BRAF V600E", "MET exon 14 skipping", "RET fusion"}
...
def sample_case(rng: random.Random) -> dict:
    ...
    case = {
        "age": rng.randint(45, 88), "sex": rng.choice(["M", "F"]),
        ...
        "size_mm": size, "histology": histology, "t": t, "n": n, "m": m,
        "driver": "none" if histology == "small cell carcinoma" else rng.choice(DRIVERS),
        "pdl1": rng.choice(PDL1_TPS), "ps": rng.choices([0, 1, 2, 3], weights=[4, 4, 2, 1])[0],
        "fvc": rng.randint(60, 110), "fev1": rng.randint(45, 105), "dlco": rng.randint(40, 100),
        "g8": rng.randint(8, 17), "inoperable": rng.random() < 0.3, "tnm_edition": "9th",
    }
...
HISTOLOGY_L = {
    "adenocarcinoma": {"fi": "adenokarsinooma", "sv": "adenokarcinom", "nb": "adenokarsinom",
                       "da": "adenokarcinom", "is": "kirtilfrumukrabbamein", "en": "adenocarcinoma"},
    "squamous cell carcinoma": {"fi": "levyepiteelikarsinooma", "sv": "skivepitelcancer",
                                "nb": "plateepitelkarsinom", "da": "planocellulært karcinom",
                                "is": "flöguþekjukrabbamein", "en": "squamous cell carcinoma"},
    "small cell carcinoma": {"fi": "pienisoluinen karsinooma", "sv": "småcellig lungcancer",
                             "nb": "småcellet karsinom", "da": "småcellet karcinom",
                             "is": "smáfrumukrabbamein", "en": "small cell carcinoma"},
    "nsclc_nos": {"fi": "ei-pienisoluinen karsinooma NOS", "sv": "icke-småcellig lungcancer UNS",
                  "nb": "ikke-småcellet karsinom UNS", "da": "ikke-småcellet karcinom UNS",
                  "is": "ekki-smáfrumukrabbamein NOS", "en": "non-small cell carcinoma NOS"},
}
TREATMENT_L = {
    "SABR": {l: "SABR" for l in "fi sv nb da is en".split()},
    "lobectomy": {"fi": "lobektomia", "sv": "lobektomi", "nb": "lobektomi", "da": "lobektomi",
                  "is": "blaðnám", "en": "lobectomy"},
    "concurrent chemoradiotherapy": {
        "fi": "konkomitantti kemosädehoito", "sv": "konkomitant kemoradioterapi",
        "nb": "konkomitant kjemoradioterapi", "da": "konkomitant kemoradioterapi",
        "is": "samhliða krabbameinslyfja- og geislameðferð", "en": "concurrent chemoradiotherapy"},
    "targeted therapy": {"fi": "täsmälääkehoito", "sv": "målriktad behandling",
                         "nb": "målrettet behandling", "da": "målrettet behandling",
                         "is": "marksækin meðferð", "en": "targeted therapy"},
    "immunotherapy": {"fi": "immunoterapia", "sv": "immunterapi", "nb": "immunterapi",
                      "da": "immunterapi", "is": "ónæmismeðferð", "en": "immunotherapy"},
    "chemo-immunotherapy": {"fi": "kemoimmunoterapia", "sv": "kemoimmunterapi",
                            "nb": "kjemoimmunterapi", "da": "kemoimmunterapi",
                            "is": "krabbameinslyfja- og ónæmismeðferð", "en": "chemo-immunotherapy"},
    "best supportive care": {"fi": "oireenmukainen hoito", "sv": "bästa understödjande vård",
                             "nb": "best mulig støttebehandling",
                             "da": "bedste understøttende behandling",
                             "is": "líknandi meðferð", "en": "best supportive care"},
}
INTENT_L = {
    "curative": {"fi": "kuratiivinen", "sv": "kurativ", "nb": "kurativ", "da": "kurativ",
                 "is": "læknandi", "en": "curative"},
    "potentially curative": {"fi": "mahdollisesti kuratiivinen", "sv": "potentiellt kurativ",
                             "nb": "potensielt kurativ", "da": "potentielt kurativ",
                             "is": "mögulega læknandi", "en": "potentially curative"},
    "life-prolonging palliative": {"fi": "elämää pidentävä palliatiivinen",
                                   "sv": "livsförlängande palliativ",
                                   "nb": "livsforlengende palliativ",
                                   "da": "livsforlængende palliativ",
                                   "is": "líflengjandi líknandi", "en": "life-prolonging palliative"},
    "best supportive care": {"fi": "paras oireenmukainen hoito", "sv": "bästa understödjande vård",
                             "nb": "best mulig støttebehandling",
                             "da": "bedste understøttende behandling",
                             "is": "líknandi meðferð", "en": "best supportive care"},
}
DRIVER_NONE_L = {"fi": "ei toimintakelpoisia muutoksia", "sv": "inga targeterbara förändringar",
                 "nb": "ingen målbare endringer", "da": "ingen targeterbare forandringer",
                 "is": "engar marktækar breytingar", "en": "no actionable alteration"}
SEX_L = {"M": {"fi": "mies", "sv": "man", "nb": "mann", "da": "mand", "is": "karl", "en": "man"},
         "F": {"fi": "nainen", "sv": "kvinna", "nb": "kvinne", "da": "kvinde", "is": "kona",
               "en": "woman"}}
SMOKING_L = {
    "never": {"fi": "ei koskaan tupakoinut", "sv": "aldrig rökt", "nb": "aldri røkt",
              "da": "aldrig røget", "is": "hefur aldrei reykt", "en": "never-smoker"},
    "former": {"fi": "entinen tupakoitsija", "sv": "f.d. rökare", "nb": "tidligere røyker",
               "da": "tidligere ryger", "is": "fyrrum reykingamaður", "en": "former smoker"},
    "current": {"fi": "tupakoiva", "sv": "aktiv rökare", "nb": "aktiv røyker",
                "da": "aktiv ryger", "is": "reykingamaður", "en": "current smoker"},
}
SIDE_L = {"right": {"fi": "oikean", "sv": "höger", "nb": "høyre", "da": "højre", "is": "hægra",
                    "en": "right"},
          "left": {"fi": "vasemman", "sv": "vänster", "nb": "venstre", "da": "venstre",
                   "is": "vinstra", "en": "left"}}
LOBE_L = {"upper": {"fi": "ylälohko", "sv": "överlob", "nb": "overlapp", "da": "overlap",
                    "is": "efra blað", "en": "upper lobe"},
          "middle": {"fi": "keskilohko", "sv": "mellanlob", "nb": "midtlapp", "da": "mellemlap",
                     "is": "miðblað", "en": "middle lobe"},
          "lower": {"fi": "alalohko", "sv": "underlob", "nb": "underlapp", "da": "underlap",
                    "is": "neðra blað", "en": "lower lobe"}}
PET_L = {"fi": ["ei etäpesäkkeisiin viittaavaa", "epäselvä lisämunuaislöydös"],
...
TEMPLATES = {
    "fi": ("Keuhkosyövän MDT-kokous, {hospital}. {age}-vuotias {sex}, {smoking} ({pack} pakettivuotta), "
           ...
           "hoito {f:treatment}."),
    "sv": ("Lungcancer-MDK, {hospital}. {age}-årig {sex}, {smoking} ({pack} packår), ECOG {ps}, "
    ...
    "nb": ("Lungekreft-MDT, {hospital}. {age} år gammel {sex}, {smoking} ({pack} pakkeår), ECOG {ps}, "
           ...
           "behandling {f:treatment}."),
    "da": ("Lungekræft-MDT, {hospital}. {age}-årig {sex}, {smoking} ({pack} pakkeår), ECOG {ps}, "
           "G8 {g8}. CT: {size} mm tumor i {side} lunges {lobe}. PET-CT: {pet}. "
           "Patologi ({edition} TNM): {f:histology}. {beforeclause}Biomarkører: {f:pdl1}; driver {f:driver}. "
           "MDT-anbefaling: cTNM {f:clinical_stage} (gruppe {group}), intention {f:intent}, "
           "behandling {f:treatment}."),
    "is": ("Lungnakrabbameins-MDT, {hospital}. {age} ára {sex}, {smoking} ({pack} pakkaár), ECOG {ps}, "
           ...
           "meðferð {f:treatment}."),
    "en": ("Lung cancer MDT meeting, {hospital}. {age}-year-old {sex}, {smoking} ({pack} pack-years), "
...
HOSPITALS = {"fi": "TAYS", "sv": "Karolinska", "nb": "OUS", "da": "Rigshospitalet",
             "is": "Landspítali", "en": "University Hospital"}
...
BEFORE_LABEL = {"fi": "MDT:tä edeltävä cTNM", "sv": "cTNM före MDK", "nb": "cTNM før MDT",
                "da": "cTNM før MDT", "is": "cTNM fyrir MDT", "en": "Pre-MDT cTNM"}
...
def _render(template: str, plain: dict, golds: dict) -> tuple[str, dict]:
    ...
    for m in _TOKEN.finditer(template):
        ...
        if m.group(1):
            ...
            fields[name] = {"value": value, "span": [pos, pos + len(value)],
                            "canonical": canonical, "field_type": ftype}
            out.append(value)
            pos += len(value)
        else:
...
def render_free_text(case: dict, lang: str, rng: random.Random) -> tuple[str, dict]:
    plain = {"hospital": HOSPITALS[lang], "age": case["age"], "sex": SEX_L[case["sex"]][lang],
             "smoking": SMOKING_L[case["smoking"]][lang], "pack": case["pack_years"],
             "ps": case["ps"], "g8": case["g8"], "size": case["size_mm"],
             "side": SIDE_L[case["side"]][lang], "lobe": LOBE_L[case["lobe"]][lang],
             "pet": rng.choice(PET_L[lang]), "edition": case["tnm_edition"],
...
def render_semistructured(case: dict, rng: random.Random) -> tuple[str, dict]:
    plain = {"hospital": "University Hospital", "presenter": "oncologist", "age": case["age"],
             "sex": SEX_L[case["sex"]]["en"], "smoking": SMOKING_L[case["smoking"]]["en"],
             "pack": case["pack_years"], "ps": case["ps"], "g8": case["g8"],
             "fvc": case["fvc"], "fev1": case["fev1"], "dlco": case["dlco"],
             "size": case["size_mm"], "side": case["side"], "lobe": LOBE_L[case["lobe"]]["en"],
             "pet": rng.choice(PET_L["en"]), "edition": "9th", "group": case["stage_group"],
...
def render_structured(case: dict) -> tuple[str, dict]:
    plain = {"age": case["age"], "sex": case["sex"], "smoking": case["smoking"],
             "pack": case["pack_years"], "ps": case["ps"], "g8": case["g8"],
             "fvc": case["fvc"], "fev1": case["fev1"], "dlco": case["dlco"],
             "side": case["side"], "lobe": case["lobe"].replace(" lobe", ""),
             "size": case["size_mm"], "group": case["stage_group"],
...
def _seed(group: str, i: int) -> int:
    return zlib.adler32(f"notevahti::{group}::{i}".encode("utf-8"))


def generate(n: int, out_dir: pathlib.Path) -> dict:
    out_dir.mkdir(parents=True, exist_ok=True)
    manifest = {"n_per_group": n, "groups": {}, "gold_fields": GOLD_FIELDS,
                "tools": {"free": "ntog.org/mdt.html",
                          "semi": "ntog.org/mdt-structured-mini.html",
                          "struct": "ntog.org/mdt-structured-v3_1.html"}}
    groups = [(f"free_{l}", "free", l) for l in FREE_LANGS]
    ...
    for group, kind, lang in groups:
        ...
        with open(path, "w", encoding="utf-8") as fh:
            for i in range(n):
                ...
                rec = {"case_id": f"{group}-{i:04d}", "group": group, "modality": kind,
                       "language": lang, "note": text, "fields": fields,
